  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px", color: "#fff" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <div style={{ fontSize: 28, fontWeight: 700 }}>Venue Approvals</div>
      </div>
      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 11, color: "#888", textTransform: "uppercase", letterSpacing: "0.2em", marginBottom: 16 }}>Pending - {pending.length}</div>
      ...
      <div>
        <div style={{ fontSize: 11, color: "#888", textTransform: "uppercase", letterSpacing: "0.2em", marginBottom: 16 }}>Live - {active.length}</div>
        {active.map(venue => (
