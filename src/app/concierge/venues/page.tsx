                  ...
                  {grouped[category].map(venue => {
                    ...
                    return (
                      <div key={venue.id} className="venue-card">
                        ...
                        {venue.area && (
                          <div style={{ fontSize: 11, color: 'var(--muted)', fontFamily: 'monospace', letterSpacing: '0.1em', textTransform: 'uppercase', marginTop: 2
cat > ~/Downloads/ISLA\ NETWORK/src/app/concierge/venues/page.tsx << 'ENDOFFILE'
import { createClient } from '@/lib/supabase/server'
import { redirect } from 'next/navigation'
